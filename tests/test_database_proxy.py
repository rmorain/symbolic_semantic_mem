...
class TestWikiDatabase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_entity = ['Q5284', 'Bill Gates', 
                'American business magnate and philanthropist']
        self.test_associations = [['P25', 'Q454928'], ['P19', 'Q5083'], 
                ['P26', 'Q463877'], ['P106', 'Q131524'], ['P27', 'Q30'], 
                ['P108', 'Q655286'], ['P69', 'Q7879362'], ['P910', 'Q7112419'], 
                ['P31', 'Q5'], ['P551', 'Q1506847'], ['P166', 'Q12201445'], 
                ['P1343', 'Q17311605'], ['P735', 'Q12344159'], 
                ['P39', 'Q484876'], ['P734', 'Q16870134'], ['P40', 'Q23011254'], 
                ['P172', 'Q7435494'], ['P463', 'Q463303'], ['P3438', 'Q575937'], 
                ['P1412', 'Q1860'], ['P21', 'Q6581097'], ['P1830', 'Q2283'], 
                ['P1441', 'Q12125162'], ['P6886', 'Q1860'], ['P641', 'Q188966'], 
                ['P552', 'Q789447'], ['P22', 'Q684014'], ['P8017', 'L19333-F1'], 
                ['P6553', 'L485'], ['P3373', 'Q92466067'], ['P1344', 'Q16972891']]
    ...
    def test_format_associations(self):
        # Successful
        formatted_associations = self.db.format_associations(self.test_entity, self.test_associations)
