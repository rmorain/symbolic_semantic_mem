...
DEBUG = True
# Process knowledge
DATA_PATH = "data/augmented_datasets/entities/train/"
SAVE_PATH = "data/augmented_datasets/pickle/augmented_train_sealed.pkl"
df = process_knowledge(DATA_PATH, SAVE_PATH, debug=DEBUG)

# Generate attention scores
SAVE_PATH = "data/augmented_datasets/pickle/sorted_attentions_train_sealed.pkl"
tokenizer = GPT2Tokenizer.from_pretrained("gpt2")
main_df = process_data(df, SAVE_PATH, tokenizer, debug=DEBUG)

# Max attention
SAVE_PATH = "data/augmented_datasets/pickle/max_attention_sealed.pkl"
max_df = process_max_attention(deepcopy(main_df), SAVE_PATH, debug=DEBUG)

# Median attention
SAVE_PATH = "data/augmented_datasets/pickle/median_attention_sealed.pkl"
med_df = process_median_attention(deepcopy(main_df), SAVE_PATH, debug=DEBUG)

# Min attention
SAVE_PATH = "data/augmented_datasets/pickle/min_attention_sealed.pkl"
